...
const NftItemHistoryScreen = (props:any) => {
    ...
    console.log(props.route,'nftitem')
    ...
    const getItemTransactionsHistory = async (walletAddress:string, nftId:string) => {
        ...
        <Fragment>
            ...
            <View style={{...styles.contentContainer, margin: 0}}>
                ...
                <TouchableOpacity
                    ...
                    {imageMimetypes[item.nftMimetype?item.nftMimetype:'image/png'] && (
                        <FastImage
            ...
            <View style={styles.modal}>
                ...
                <TouchableOpacity onPress={closeModal}>
                    <Image alt='modal image' source={avatarSource} style={styles.modalImage} />
                </TouchableOpacity>
                )}
