...
//Wallet requests
export const FETCHING_TOKEN_ETHER_BALANCE_SUCCESS = 'FETCHING_TOKEN_ETHER_BALANCE_SUCCESS';
...
export const FETCHING_OTHER_USER_TRANSACTION_SUCCESS = "FETCHING_OTHER_USER_TRANSACTION_SUCCESS";
...
export const FETCHING_OTHER_USER_TOKEN_BALANCE_SUCCESS = "FETCHING_OTHER_USER_TOKEN_BALANCE_SUCCESS";
...
export const FETCHING_ADD_EMAIL_TO_LIST_SUCCESS = "FETCHING_ADD_EMAIL_TO_LIST_SUCCESS";
export const FETCHING_ADD_EMAIL_TO_LIST_FAILURE = "FETCHING_ADD_EMAIL_TO_LIST_FAILURE";
export const FETCHING_DELETE_EMAIL_FROM_LIST = "FETCHING_DELETE_EMAIL_FROM_LIST";
export const FETCHING_DELETE_EMAIL_FROM_LIST_SUCCESS = "FETCHING_DELETE_EMAIL_FROM_LIST_SUCCESS";
export const FETCHING_DELETE_EMAIL_FROM_LIST_FAILURE = "FETCHING_DELETE_EMAIL_FROM_LIST_SUCCESS";
