...
const body12 = "We will update this privacy policy as needed so that it is current, accurate, and as clear as possible. Your continued use of our Services confirms your acceptance of our updated Privacy Policy.";

const heading13 = "Terms";
const body13 = "Please also read our Terms of Service above which also governs the terms of this Privacy Policy.";

const heading14 = "Contact Us";
const body14 = "If you have questions about our Privacy Policy please contact us at privacy@dappros.con. Attn: Dappros Ltd, 38 Munden Grove, Watford, WD24 7EE, United Kingdom.";

const effectiveDate = "Effective as of June 21, 2021"

const renderItem = (item) => {
    console.log(item,"Asffbhdgbhnhdgnfghndghb")
    return(
        <Text style={styles.bodyTextStyle} key={item.index}>{`\u2022 ${item.item}`}</Text>
    )
}
...
const PrivacyPolicy = () => (
    <ScrollView showsVerticalScrollIndicator style={styles.mainContainer}>
        ...
        <View style={styles.subBodyContainer}>
            ...
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Minimum Age.</Text> {body31}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Account Registration.</Text> {body32}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Privacy of user data.</Text> {body33}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Software.</Text> {body34}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Fees and Taxes.</Text> {body35}</Text>
        </View>

        <View style={styles.subBodyContainer}>
            <Text style={styles.headingTextStyle}>{heading4}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Our Terms and Policies.</Text> {body41}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Legal and Acceptable Use.</Text> {body42}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Harm to Ethora.</Text> {body43}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Keeping Your Account Secure.</Text> {body44}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>No Access to Emergency Services.</Text> {body45}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Third-party services.</Text> {body46}</Text>
        </View>

        <View style={styles.subBodyContainer}>
            <Text style={styles.headingTextStyle}>{heading5}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Your Rights.</Text> {body51}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Ethora’s Rights.</Text> {body52}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Ethora’s License to You.</Text> {body53}</Text>
        </View>

        <View style={styles.subBodyContainer}>
            <Text style={styles.headingTextStyle}>{heading6}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Disclaimers.</Text> {body61}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Limitation of liability.</Text> {body62}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Availability of Our Services.</Text> {body63}</Text>
        </View>

        <View style={styles.subBodyContainer}>
            <Text style={styles.headingTextStyle}>{heading7}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Resolving disputes.</Text> {body71}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Ending these Terms.</Text> {body72}</Text>
        </View>
        ...
        <View style={styles.subBodyContainer}>
            ...
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Account Information.</Text> {body101}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Messages.</Text> {body102}</Text>
            <Text style={styles.bodyTextStyle}>{body103}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Contacts.</Text> {body104}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>User Support.</Text> {body105}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Managing your information.</Text> {body106}</Text>
        </View>

        <View style={styles.subBodyContainer}>
            <Text style={styles.headingTextStyle}>{heading11}</Text>
            <Text style={styles.bodyTextStyle}><Text style={{fontFamily:boldFont}}>Third Parties.</Text> {body111}</Text>
        </View>
