...
let errorCodes = [
  ...
  },
  {
    ...
    description: 'Your login credentials have expired. Please login again',
  },
  {
    code: 500,
              ...
              if (title === errorCodes[1].title) {
                ...
                Alert.alert(title, description, [
                  ...
                  },
                  {
                    text: 'Retry',
                    onPress: () =>
                      this.fetchPost(url, data, token, logOut, callback),
                  },
                ]);
              }
            });
              ...
              if (title === errorCodes[1].title) {
                ...
                Alert.alert(title, description, [
                  ...
                  },
                  {
                    text: 'Retry',
                    onPress: () =>
                      this.fetchDelete(url, token, logOut, callback),
                  },
                ]);
              }
            });
              ...
              if (error.response.status === 404) {
                ...
                Alert.alert(title, description, [
                  ...
                  },
                  {
                    text: 'Retry',
                    onPress: () =>
                      this.fetchHubspotContact(url, logOut, callback),
                  },
                ]);
              }
            });
            ...
            Alert.alert(
              ...
              [
                ...
                },
                {
                  text: 'Retry',
                  onPress: () =>
                    this.fetchHubspotContact(url, token, logOut, callback),
                },
              ],
            );
          }
