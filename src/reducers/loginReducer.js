...
const loginReducer = (state = initialState, action) => {
    switch(action.type) {
        ...
        case types.UPDATE_USER_PROFILE:
            return {...state, userDescription:action.payload.desc, userAvatar:action.payload.photoURL}

        case types.SET_OTHER_USER_VCARD:
            return {...state, isFetching:false, error:false, anotherUserAvatar:action.payload.anotherUserAvatar, anotherUserDescription:action.payload.anotherUserDescription}

        case types.SET_OTHER_USER_DETAILS:
            return {...state, isFetching:false, error:false, anotherUserFirstname:action.payload.anotherUserFirstname, anotherUserLastname:action.payload.anotherUserLastname, anotherUserWalletAddress:action.payload.anotherUserWalletAddress, isPreviousUser:action.payload.isPrevious}

        case types.SET_IS_PREVIOUS_USER:
            return {...state, isFetching:false, error:false, isPreviousUser:action.payload}
