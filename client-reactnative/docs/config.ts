...
//universal link url
//@ts-ignore
const environment = appEndpoint === "PROD" ? "p" : "d";
...
const logoWidth = 75; //represents the percentage of the width of device
const logoHeight = 77; //represents the percetage of the height of the device
...
export { default as logoPath } from "../src/assets/logo.png";
export { default as loginScreenBackgroundImage } from "../src/assets/login_background.png";
export { default as coinImagePath } from "../src/assets/coin.png";
