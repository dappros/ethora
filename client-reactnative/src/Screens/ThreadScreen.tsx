...
import { ActivityIndicator, Animated, Image, NativeModules, Platform, Pressable, StyleSheet } from 'react-native';
...
import { isComposing, pausedComposing, retrieveOtherUserVcard, sendInvite, sendMediaMessageStanza, sendMessageStanza } from '../xmpp/stanzas';
...
const ThreadScreen = observer((props: any) => {
    const {loginStore, chatStore, apiStore, debugStore, walletStore} = useStores();
    ...
    const parentTime = parentDate.toLocaleTimeString([],{ hour: '2-digit', minute: '2-digit' });
