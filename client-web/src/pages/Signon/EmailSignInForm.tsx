...
export default function EmailSingInForm(props: TProps) {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      />
      <FormControl error={formik.touched.password && formik.errors.password ? true : false} fullWidth variant="standard">
      ...
      <Box sx={{ margin: 2, display: "flex", justifyContent: "center" }}>
        <Button disabled={disable} type="submit" variant="contained">Continue</Button>
      </Box>
    </form>
  );
}
